...
<html lang="es">
	...
	function load_matriz(pagina){
		...
		$("#matriz").fadeIn('slow');
		$.ajax({
			url:"<?php echo $helper->url("MatrizJuicios","index9");?>",
            type : "POST",
            async: true,			
			data: con_datos,
 ...
 <script >
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("MatrizJuicios","index9"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
         ...
         <div class="col-lg-12">
	         ...
	         <h4><i class='glyphicon glyphicon-edit'></i> Matriz Juicios Providencia Cancelación Proceso</h4>
	         </div>
	     ...
	     <br>
	     <button style="visibility:hidden" type="button" id="boton_opciones" name="boton_opciones" value="Reporte Matriz Juicios"   class="btn btn-warning" style="margin-top: 10px;"><i class="glyphicon glyphicon-print"></i> Generar Avocos Masivos</button>         
          <button style="visibility:hidden" type="button" id="boton_opciones1" name="boton_opciones1" style="display: none; margin-top: 10px;" value="Reporte Matriz Juicios"   class="btn btn-danger" ><i class="glyphicon glyphicon-print"></i> Cerrar Avocos Masivos</button>         
