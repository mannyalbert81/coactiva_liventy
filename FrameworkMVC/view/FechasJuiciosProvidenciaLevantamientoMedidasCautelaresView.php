      ...
      $("#cantidad_oficios_generar_1").click(function() {
		...
		$(document).ready(function(){
		    ...
		    $("#generar").click(function() 
			{
		    	...
		    	if(tipo_avoco == 10  && anulada_oficios == 0 && generar_oficio_discapacidad=="Si"){
		    	...
		    	if(tipo_avoco == 10  && cantidad_oficios_generar == 1 && generar_oficio_discapacidad == "Si" &&  anulada_oficios == "Si" && numero_oficios_anulada_1==""){
...
*/
		    	...
		    	if(tipo_avoco == 11  && anulada_oficios_pago == 0 && generar_oficio_fallecimiento=="Si"){
				...
				if(tipo_avoco == 11  && cantidad_oficios_generar_1 == 1 && generar_oficio_fallecimiento == "Si" &&  anulada_oficios_pago == "Si" && numero_oficios_anulada_1_pago==""){
...
// AQUI 2
				...
				if(tipo_avoco == 11  && cantidad_oficios_generar_1 == 2 && generar_oficio_fallecimiento == "Si"  ){
					...
					if(tipo_avoco == 1  && cantidad_oficios_generar == 1 && generar_oficio_fallecimiento == "Si" &&  anulada_oficios_pago == "Si" && numero_oficios_anulada_1_pago==""){
						$("#mensaje_numero_oficios_anulada_1_pago").text("Ingrese # Oficio 1");
			    		$("#mensaje_numero_oficios_anulada_1_pago").fadeIn("slow"); //Muestra mensaje de error
			            return false;
					}
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("MatrizJuicios","Imprimir_Providencia_Levantamiento_Medidas_Cautelares"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12 col-md-12 col-xs-12" target="_blank">
         ...
         <div class="col-lg-12 col-md-12 col-xs-12">
	         ...
	         <h4><i class='glyphicon glyphicon-edit'></i> Datos Levantamientos Medidas Cautelares</h4>
	         </div>
