...
<?php if ($resultEdit !="" ) { foreach($resultEdit as $resEdit) {?>
 ...
 <form action="<?php echo $helper->url("DocumentosGenerados","index"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
