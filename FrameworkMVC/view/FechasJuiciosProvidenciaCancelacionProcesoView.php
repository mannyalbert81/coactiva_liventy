				...
				<div id="mensaje_tipo_avoco" class="errores"></div>
                 ...
                 <FONT FACE="arial" SIZE=1.9 COLOR=red>(Seleccionar solo si desea actualizar el estado procesal del jucio.)</FONT>
			  	...
			  	<select name="tipo_ley" id="tipo_ley"  class="form-control" >
			  		...
			  		<option value="Disposición Transitoria Cuarta de la LEY ORGÁNICA PARA LA REACTIVACIÓN DE LA ECONOMÍA, FORTALECIMIENTO DE LA DOLARIZACIÓN Y MODERNIZACIÓN DE LA GESTIÓN FINANCIERA, publicada en el Segundo Suplemento del Registro Oficial N° 150 de fecha 29 de diciembre del 2017" <?php if(!empty($resultSet_edit)){ foreach ($resultSet_edit as $res_edit){ if($res_edit->tipo_ley == 'Disposición Transitoria Cuarta de la LEY ORGÁNICA PARA LA REACTIVACIÓN DE LA ECONOMÍA, FORTALECIMIENTO DE LA DOLARIZACIÓN Y MODERNIZACIÓN DE LA GESTIÓN FINANCIERA, publicada en el Segundo Suplemento del Registro Oficial N° 150 de fecha 29 de diciembre del 2017'){echo ' selected="selected" ' ;}else{}}}else{} ?>>LEY ORGÁNICA PARA LA REACTIVACIÓN DE LA ECONOMÍA, FORTALECIMIENTO DE LA DOLARIZACIÓN Y MODERNIZACIÓN DE LA GESTIÓN FINANCIERA</option> 
